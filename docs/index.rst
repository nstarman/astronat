...
The package is being actively developed in a `public repository on GitHub <https://github.com/nstarman/astronat>`_ so if you have any trouble, `open an issue <https://github.com/nstarman/astronat/issues>`_ there.
...
.. toctree::
   ...
   astronat/constants/index
   astronat/units/index
   astronat/utils/index
...
<https://github.com/nstarman/astronat>`_. If you don't feel comfortable modifying or
adding functionality, we also welcome feature requests and bug reports as
`GitHub issues <https://github.com/nstarman/astronat/issues>`_.
...
``astronat`` is free software made available under the BSD-3 License. For details see the `LICENSE <https://github.com/nstarman/utilitpy/blob/master/LICENSE>`_ file.
...
.. |Milestones| image:: https://img.shields.io/github/milestones/open/nstarman/astronat?style=flat
   :alt: GitHub milestones

.. |Open Issues| image:: https://img.shields.io/github/issues-raw/nstarman/astronat?style=flat
   :alt: GitHub issues
